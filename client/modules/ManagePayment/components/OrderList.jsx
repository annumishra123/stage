...
class OrderList extends React.Component {
  ...
  renderPaymentListSection(tabName) {
    ...
    return (
      <ReactTable
        data={tabName == "payment" ? allOrderLineList : allReturnOrderLineList}
          ...
          >
            ...
            <TabPanel>
              <button
                ...
                style={{
                  marginRight: "1em",
                  cursor: !isRefundOrderLineEnable && "not-allowed",
                }}
                disabled={!isRefundOrderLineEnable}
                onClick={this.handleClick.bind(this, "approve", "refund")}
              >
                Approve
              </button>
              <button
                className={styles.listBtn}
                style={{ cursor: !isRefundOrderLineEnable && "not-allowed" }}
                disabled={!isRefundOrderLineEnable}
                onClick={this.handleClick.bind(this, "disapprove", "refund")}
              >
                Disapprove
              </button>
